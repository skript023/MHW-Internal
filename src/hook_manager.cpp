...
namespace big
{
	hook_manager::hook_manager() :
		...
		m_maxed_effect_set(g_pointers->m_maxed_effect_set, { 0xC6, 0x40, 0x31, 0x05, 0x0F, 0xB6, 0x48, 0x31, 0x00, 0x8C, 0xD3, 0x80, 0x00, 0x00, 0x00 }),
		m_maxed_attribute(g_pointers->m_maxed_attribute, { 0x43 , 0xC6 , 0x44 , 0x34 , 0x31 , 0x07 , 0x43 , 0x0F , 0xB6 , 0x44 , 0x34 , 0x31 }),
		/*byte patching*/
